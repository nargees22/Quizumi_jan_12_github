...
// Fix: Named imports from react-router-dom for navigation, params and links
...
const PerformanceReportPage = () => {
    ...
    useEffect(() => {
        ...
        const generateRecommendations = async () => {
            ...
            try {
                // Fix: Guidelines - use process.env.API_KEY directly and create instance right before call
